    ...
    <ScrollAnimation className="py-20 bg-black relative">
      ...
      <div className="section-content container mx-auto px-4 md:px-8 lg:px-36 relative z-10">
        ...
        >
          ...
          >
            <div className="relative flex w-full items-center justify-center h-full scale-100  lg:scale-125 " style={{ contain: 'layout' }}>
              <OrbitingCircles
                className="absolute"
                radius={140}
                reverse
...
const Icons = {
  ...
  spline: () => (
    <img src={(images.spline as any).src || images.spline} alt="Spline" width="30" height="30" />
  ),
  illustrator: () => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
