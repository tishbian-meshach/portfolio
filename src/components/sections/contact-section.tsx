...
export const ContactSection = memo(function ContactSection() {
  return (
    <ScrollAnimation
      id="contact"
      className="pt-20 pb-0 bg-black w-full relative min-h-screen"
    >
      {/* Ballpit Background */}
      ...
      {/* Footer Content */}
      <div className="section-content w-full mx-auto px-4 md:px-8 relative z-20 mt-20 border-t border-white/10 pt-8 pb-8 flex flex-col md:flex-row justify-between items-center">
